...
def parse_args():
    ...
    p.add_argument("--warmup_epochs", type=str, default="80,100")
    p.add_argument("--lambda_recon", type=str, default="0.5")
    p.add_argument("--lambda_cluster", type=str, default="1.0")
    p.add_argument("--lambda_smooth", type=str, default="0.005,0.01,0.02")
    p.add_argument("--topk_edges", type=str, default="3")
    p.add_argument("--edge_adjust_interval", type=str, default="10,20")
    p.add_argument("--delta_edges", type=str, default="20")
    p.add_argument("--beta_saturation", type=str, default="0.85,0.90")
    p.add_argument("--gamma_saturation", type=str, default="0.98")
    p.add_argument("--hsl_residual_strength", type=str, default="0.3,0.5,0.7")
